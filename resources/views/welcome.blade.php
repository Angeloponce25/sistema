@extends('layouts.app', ['class' => 'off-canvas-sidebar', 'activePage' => 'login', 'title' => __('Sistema de Cobranzas')])

@section('content')
<div class="container" style="height: auto;">
  <div class="row align-items-center">
    <div class="col-md-9 ml-auto mr-auto mb-3 text-center">
    <img src="{{ asset('material') }}/img/logo-lgant.png" alt="L'Gant" width="140" height="140">
    </div>
